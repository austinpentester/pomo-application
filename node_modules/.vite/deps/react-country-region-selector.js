...
var d = ({ onChange: n2, value: i2, country: o2 = "", onBlur: l2 = () => null, id: s2 = "", name: t2 = "rcrs-region", className: d2 = "", disabled: S = false, blankOptionLabel: A = "-", showDefaultOption: g = true, defaultOptionLabel: m = "Select Region", labelType: B = "full", valueType: M = "full", countryValueType: k = "full", disableWhenEmpty: b = false, customOptions: c = [], whitelist: C = u, blacklist: N = h, customRender: K = r, ...T }) => {
  const P = (0, import_react.useMemo)(() => {
    ...
    if (e.forEach((e2) => {
      e2[a2] === o2 && (n3 = e2);
    }), !n3 || 0 === n3.length) return console.error("Error. Unknown country passed: " + o2 + `. If you're passing a country shortcode, be sure to include countryValueType="short" on the RegionDropdown`), [];
    const i3 = ((a3, n4, e2) => {
      const [i4, r3, o3] = a3, l3 = n4[r3] || [], s3 = e2[r3] || [];
      let t3 = o3.split("|");
      return l3.length > 0 && t3.length > 0 ? t3 = t3.filter((a4) => l3.some((n5) => a4.indexOf(`~${n5}`) > -1)) : s3.length > 0 && t3.length > 0 && (t3 = t3.filter((a4) => s3.every((n5) => !a4.includes(`~${n5}`)))), [i4, r3, t3.join("|")];
    })(n3, C, N);
    return i3 && i3.length ? (r2 = i3[2].split("|").map((a3) => {
      let [n4, e2 = null] = a3.split("~");
      const i4 = "short" === M && e2 ? e2 : n4;
      return { label: "short" === B && e2 ? e2 : n4, value: i4, key: i4 };
    }), r2.sort((a3, n4) => a3.label.localeCompare(n4.label))) : [];
    var r2;
  }, [o2, k, C, N]), L = (0, import_react.useMemo)(() => {
    if (!o2) return [];
    const a2 = ((a3, n4) => a3.filter(({ value: a4 }) => -1 !== n4.indexOf(a4)).map(({ label: a4 }) => a4))(P, c);
    if (a2.length) return console.error("Error: Duplicate regions present: " + a2.toString() + ".\nThe above item(s) is/are already getting added to the region dropdown by the library."), [];
    const n3 = [];
    return c.map((a3) => {
      a3 && n3.push({ value: a3, key: a3, label: a3 });
    }), n3;
  }, [P, o2, c]), R = (0, import_react.useMemo)(() => o2 ? g ? { value: "", key: "default", label: m } : void 0 : { value: "", key: "default", label: A }, [o2, A, m]), y = { ...T, name: t2, value: i2, onChange: (a2) => n2 ? n2(a2.target.value, a2) : null, onBlur: (a2) => l2(a2), disabled: S || b && "" === o2 };
  return s2 && (y.id = s2), d2 && (y.className = d2), K({ ...y, options: [R, ...P, ...L] });
};
export {
  t as CountryDropdown,
  i as CountryRegionData,
  d as RegionDropdown
};
//# sourceMappingURL=react-country-region-selector.js.map
